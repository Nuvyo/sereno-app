  ...
  (
    ...
    const updatePosition = React.useCallback(() => {
      ...
      if (side === 'bottom' && t.bottom + sideOffset + c.height + collisionPadding > viewportH) {
        ...
        chosenSide = 'bottom';
      } else if (side === 'right' && t.right + sideOffset + c.width + collisionPadding > viewportW) {
        chosenSide = 'left';
      ...
      if (chosenSide === 'bottom') top = t.bottom + sideOffset;

      if (chosenSide === 'top') top = t.top - c.height - sideOffset;

      if (chosenSide === 'right') left = t.right + sideOffset;

      if (chosenSide === 'left') left = t.left - c.width - sideOffset;
