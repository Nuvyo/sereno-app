...
const Sheet = ({ open: openProp, defaultOpen, onOpenChange, children }: SheetProps) => {
  ...
  const ctx: SheetContextValue = React.useMemo(() => ({ open, setOpen, setLastActiveElement }), [open, setOpen]);
...
const SheetTrigger = React.forwardRef<HTMLButtonElement, SheetTriggerProps>(
  ({ asChild, onClick, children, ...rest }, ref) => {
    ...
    if (asChild && React.isValidElement(children)) {
      ...
      const childOnClick = childEl.props?.onClick as ((e: React.MouseEvent<HTMLElement>) => void) | undefined;
